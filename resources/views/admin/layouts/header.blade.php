    ...
    <div id="kt_header" style="" class="header align-items-stretch">
        ...
        <div class="header-brand">
            ...
            <a href="../../demo8/dist/index.html">
                <img alt="Logo" src="/assets/metronic/media/logos/logo-1-dark.svg" class="h-25px h-lg-25px" />
            </a>
            <!--end::Logo-->
        ...
        <div class="toolbar">
            ...
            <div
                ...
                <div class="page-title d-flex flex-column me-5">
                    <!--begin::Title-->
                    <h1 class="d-flex flex-column text-dark fw-bolder fs-3 mb-0" id="title-header">Dashboard</h1>
                    <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 pt-1" id="breadCrumbTitle">
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <div class="menu menu-sub menu-sub-dropdown menu-column w-350px w-lg-375px"
                                    ...
                                    <div class="d-flex flex-column bgi-no-repeat rounded-top"
                                        style="background-image:url({{  url('/assets/metronic/media/misc/pattern-1.jpg')  }})">
                                        <!--begin::Title-->
