                            ...
                            <div class="overflow-auto pb-5">
                                <div class="d-flex align-items-center border border-dashed border-gray-300 rounded min-w-700px p-5">
                                    ...
                                    <div class="d-flex flex-aligns-center pe-10 pe-lg-20">
                                        <!--begin::Icon-->
                                        <img alt="" class="w-30px me-3" src="/assets/metronic/media/svg/files/pdf.svg" />
                                        <!--end::Icon-->
                                        <!--begin::Info-->
                                    ...
                                    <div class="d-flex flex-aligns-center pe-10 pe-lg-20">
                                        <!--begin::Icon-->
                                        <img alt="" class="w-30px me-3" src="/assets/metronic/media/svg/files/doc.svg" />
                                        <!--end::Icon-->
                                        <!--begin::Info-->
                                        <div class="ms-1 fw-bold">
                                            <!--begin::Desc-->
                                    ...
                                    <div class="d-flex flex-aligns-center">
                                        <!--begin::Icon-->
                                        <img alt="" class="w-30px me-3" src="/assets/metronic/media/svg/files/css.svg" />
                                        <!--end::Icon-->
                                        <!--begin::Info-->
                                        <div class="ms-1 fw-bold">
                                            <!--begin::Desc-->
                                ...
                                <div class="d-flex align-items-center border border-dashed border-gray-300 rounded min-w-700px p-7">
                                    ...
                                    <div class="overlay me-10">
                                        ...
                                        <div class="overlay-wrapper">
                                            <img alt="img" class="rounded w-200px" src="/assets/metronic/media/demos/demo1.png" />
                                        </div>
                                        <!--end::Image-->
                                        <!--begin::Link-->
                                    ...
                                    <div class="overlay me-10">
                                        <!--begin::Image-->
                                        <div class="overlay-wrapper">
                                            <img alt="img" class="rounded w-200px" src="/assets/metronic/media/demos/demo2.png" />
                                        </div>
                                        <!--end::Image-->
                                        <!--begin::Link-->
                                        <div class="overlay-layer bg-dark bg-opacity-10 rounded">
                                    ...
                                    <div class="overlay">
                                        <!--begin::Image-->
                                        <div class="overlay-wrapper">
                                            <img alt="img" class="rounded w-200px" src="/assets/metronic/media/demos/demo3.png" />
                                        </div>
                                        <!--end::Image-->
                                        <!--begin::Link-->
                                        <div class="overlay-layer bg-dark bg-opacity-10 rounded">
                        ...
                        <div class="row g-5">
                            ...
                            <div class="col-6">
                                ...
                                <div class="overlay overflow-hidden position-relative rounded">
                                    <div class="overlay-wrapper">
                                        <img src="/assets/metronic/media/demos/demo1.png" alt="demo" class="w-100" />
                                    </div>
                            ...
                            <div class="col-6">
                                ...
                                <div class="overlay overflow-hidden position-relative rounded">
                                    <div class="overlay-wrapper">
                                        <img src="/assets/metronic/media/demos/demo2.png" alt="demo" class="w-100" />
                                    </div>
                                    <div class="overlay-layer bg-dark bg-opacity-10">
                            ...
                            <div class="col-6">
                                ...
                                <div class="overlay overflow-hidden position-relative rounded">
                                    <div class="overlay-wrapper">
                                        <img src="/assets/metronic/media/demos/demo3.png" alt="demo" class="w-100" />
                                    </div>
                                    <div class="overlay-layer bg-dark bg-opacity-10">
                            ...
                            <div class="col-6">
                                ...
                                <div class="overlay overflow-hidden position-relative rounded">
                                    <div class="overlay-wrapper">
                                        <img src="/assets/metronic/media/demos/demo4.png" alt="demo" class="w-100" />
                                    </div>
                                    <div class="overlay-layer bg-dark bg-opacity-10">
                            ...
                            <div class="col-6">
                                ...
                                <div class="overlay overflow-hidden position-relative rounded">
                                    <div class="overlay-wrapper">
                                        <img src="/assets/metronic/media/demos/demo5.png" alt="demo" class="w-100" />
                                    </div>
                                    <div class="overlay-layer bg-dark bg-opacity-10">
                            ...
                            <div class="col-6">
                                ...
                                <div class="overlay overflow-hidden position-relative rounded">
                                    <div class="overlay-wrapper">
                                        <img src="/assets/metronic/media/demos/demo6.png" alt="demo" class="w-100" />
                                    </div>
                                    <div class="overlay-layer bg-dark bg-opacity-10">
                            ...
                            <div class="col-6">
                                ...
                                <div class="overlay overflow-hidden position-relative rounded">
                                    <div class="overlay-wrapper">
                                        <img src="/assets/metronic/media/demos/demo7.png" alt="demo" class="w-100" />
                                    </div>
                                    <div class="overlay-layer bg-dark bg-opacity-10">
                            ...
                            <div class="col-6">
                                ...
                                <div class="overlay overflow-hidden position-relative border border-4 border-success rounded">
                                    <div class="overlay-wrapper">
                                        <img src="/assets/metronic/media/demos/demo8.png" alt="demo" class="w-100" />
                                    </div>
                                    <div class="overlay-layer bg-dark bg-opacity-10">
                            ...
                            <div class="col-6">
                                ...
                                <div class="overlay overflow-hidden position-relative rounded">
                                    <div class="overlay-wrapper">
                                        <img src="/assets/metronic/media/demos/demo9.png" alt="demo" class="w-100" />
                                    </div>
                                    <div class="overlay-layer bg-dark bg-opacity-10">
                            ...
                            <div class="col-6">
                                ...
                                <div class="overlay overflow-hidden position-relative rounded">
                                    <div class="overlay-wrapper">
                                        <img src="/assets/metronic/media/demos/demo10.png" alt="demo" class="w-100 opacity-75" />
                                    </div>
                                    <div class="overlay-layer bg-dark bg-opacity-10">
                            ...
                            <div class="col-6">
                                ...
                                <div class="overlay overflow-hidden position-relative rounded">
                                    <div class="overlay-wrapper">
                                        <img src="/assets/metronic/media/demos/demo11.png" alt="demo" class="w-100" />
                                    </div>
                                    <div class="overlay-layer bg-dark bg-opacity-10">
                            ...
                            <div class="col-6">
                                ...
                                <div class="overlay overflow-hidden position-relative rounded">
                                    <div class="overlay-wrapper">
                                        <img src="/assets/metronic/media/demos/demo12.png" alt="demo" class="w-100 opacity-75" />
                                    </div>
                                    <div class="overlay-layer bg-dark bg-opacity-10">
                                        <div class="badge badge-white px-6 py-4 fw-bold fs-base shadow">Coming soon</div>
                                    </div>
                            ...
                            <div class="col-6">
                                ...
                                <div class="overlay overflow-hidden position-relative rounded">
                                    <div class="overlay-wrapper">
                                        <img src="/assets/metronic/media/demos/demo13.png" alt="demo" class="w-100" />
                                    </div>
                                    <div class="overlay-layer bg-dark bg-opacity-10">
                            ...
                            <div class="col-6">
                                ...
                                <div class="overlay overflow-hidden position-relative rounded">
                                    <div class="overlay-wrapper">
                                        <img src="/assets/metronic/media/demos/demo14.png" alt="demo" class="w-100 opacity-75" />
                                    </div>
                                    <div class="overlay-layer bg-dark bg-opacity-10">
                                        <div class="badge badge-white px-6 py-4 fw-bold fs-base shadow">Coming soon</div>
                                    </div>
                            ...
                            <div class="col-6">
                                ...
                                <div class="overlay overflow-hidden position-relative rounded">
                                    <div class="overlay-wrapper">
                                        <img src="/assets/metronic/media/demos/demo15.png" alt="demo" class="w-100 opacity-75" />
                                    </div>
                                    <div class="overlay-layer bg-dark bg-opacity-10">
                                        <div class="badge badge-white px-6 py-4 fw-bold fs-base shadow">Coming soon</div>
                                    </div>
                            ...
                            <div class="col-6">
                                ...
                                <div class="overlay overflow-hidden position-relative rounded">
                                    <div class="overlay-wrapper">
                                        <img src="/assets/metronic/media/demos/demo16.png" alt="demo" class="w-100 opacity-75" />
                                    </div>
                                    <div class="overlay-layer bg-dark bg-opacity-10">
                                        <div class="badge badge-white px-6 py-4 fw-bold fs-base shadow">Coming soon</div>
                                    </div>
                            ...
                            <div class="col-6">
                                ...
                                <div class="overlay overflow-hidden position-relative rounded">
                                    <div class="overlay-wrapper">
                                        <img src="/assets/metronic/media/demos/demo17.png" alt="demo" class="w-100 opacity-75" />
                                    </div>
                                    <div class="overlay-layer bg-dark bg-opacity-10">
                                        <div class="badge badge-white px-6 py-4 fw-bold fs-base shadow">Coming soon</div>
                                    </div>
                            ...
                            <div class="col-6">
                                ...
                                <div class="overlay overflow-hidden position-relative rounded">
                                    <div class="overlay-wrapper">
                                        <img src="/assets/metronic/media/demos/demo18.png" alt="demo" class="w-100 opacity-75" />
                                    </div>
                                    <div class="overlay-layer bg-dark bg-opacity-10">
                                        <div class="badge badge-white px-6 py-4 fw-bold fs-base shadow">Coming soon</div>
                                    </div>
                            ...
                            <div class="col-6">
                                ...
                                <div class="overlay overflow-hidden position-relative rounded">
                                    <div class="overlay-wrapper">
                                        <img src="/assets/metronic/media/demos/demo19.png" alt="demo" class="w-100 opacity-75" />
                                    </div>
                                    <div class="overlay-layer bg-dark bg-opacity-10">
                                        <div class="badge badge-white px-6 py-4 fw-bold fs-base shadow">Coming soon</div>
                                    </div>
                            ...
                            <div class="col-6">
                                ...
                                <div class="overlay overflow-hidden position-relative rounded">
                                    <div class="overlay-wrapper">
                                        <img src="/assets/metronic/media/demos/demo20.png" alt="demo" class="w-100 opacity-75" />
                                    </div>
                                    <div class="overlay-layer bg-dark bg-opacity-10">
                                        <div class="badge badge-white px-6 py-4 fw-bold fs-base shadow">Coming soon</div>
                                    </div>
    ...
    <div class="modal-dialog mw-650px">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body scroll-y mx-5 mx-xl-18 pt-0 pb-15">
                ...
                <img alt="Logo" src="/assets/metronic/media/svg/brand-logos/google-icon.svg" class="h-20px me-3" />Invite Gmail Contacts</div>
                                    ...
                                    <div class="d-flex flex-column mb-7 fv-row">
                                        ...
                                        <div class="position-relative">
                                            ...
                                            <div class="position-absolute translate-middle-y top-50 end-0 me-5">
                                                <img src="/assets/metronic/media/svg/card-logos/visa.svg" alt="" class="h-25px" />
                                                <img src="/assets/metronic/media/svg/card-logos/mastercard.svg" alt="" class="h-25px" />
                                                <img src="/assets/metronic/media/svg/card-logos/american-express.svg" alt="" class="h-25px" />
                                            </div>
                                            <!--end::Card logos-->
                                        </div>
                                        <!--end::Input wrapper-->
                            ...
                            <div data-kt-stepper-element="content">
                                <div class="w-100 text-center">
                                    ...
                                    <div class="text-center px-4 py-15">
                                        <img src="/assets/metronic/media/illustrations/sketchy-1/9.png" alt="" class="w-100 mh-300px" />
                                    </div>
                                    <!--end::Illustration-->
                                </div>
                            </div>
