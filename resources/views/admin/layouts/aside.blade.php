    ...
    <div class="aside-toolbar flex-column-auto" id="kt_aside_toolbar">
        ...
        <div class="aside-user d-flex align-items-sm-center justify-content-center py-5">
            ...
            <div class="symbol symbol-50px">
                <img src="/assets/metronic/media/avatars/150-26.jpg" alt="" />
            </div>
            <!--end::Symbol-->
            <!--begin::Wrapper-->
                            ...
                            <div class="menu-item px-3">
                                <div class="menu-content d-flex align-items-center px-3">
                                    ...
                                    <div class="symbol symbol-50px me-5">
                                        <img alt="Logo" src="/assets/metronic/media/avatars/150-26.jpg" />
                                    </div>
                                    <!--end::Avatar-->
                                    <!--begin::Username-->
                                ...
                                <div class="menu-sub menu-sub-dropdown w-175px py-4">
                                    ...
                                    <div class="menu-item px-3">
                                        <a href="../../demo8/dist/account/settings.html"
                                            ...
                                            <span class="symbol symbol-20px me-4">
                                                <img class="rounded-1" src="/assets/metronic/media/flags/spain.svg"
                                                    alt="" />
                                            </span>Spanish</a>
                                    </div>
                                    <!--end::Menu item-->
                                    ...
                                    <div class="menu-item px-3">
                                        <a href="../../demo8/dist/account/settings.html"
                                            class="menu-link d-flex px-5">
                                            <span class="symbol symbol-20px me-4">
                                                <img class="rounded-1" src="/assets/metronic/media/flags/germany.svg"
                                                    alt="" />
                                            </span>German</a>
                                    </div>
                                    <!--end::Menu item-->
                                    ...
                                    <div class="menu-item px-3">
                                        <a href="../../demo8/dist/account/settings.html"
                                            class="menu-link d-flex px-5">
                                            <span class="symbol symbol-20px me-4">
                                                <img class="rounded-1" src="/assets/metronic/media/flags/japan.svg"
                                                    alt="" />
                                            </span>Japanese</a>
                                    </div>
                                    <!--end::Menu item-->
                                    ...
                                    <div class="menu-item px-3">
                                        <a href="../../demo8/dist/account/settings.html"
                                            class="menu-link d-flex px-5">
                                            <span class="symbol symbol-20px me-4">
                                                <img class="rounded-1" src="/assets/metronic/media/flags/france.svg"
                                                    alt="" />
                                            </span>French</a>
                                    </div>
                                    <!--end::Menu item-->
