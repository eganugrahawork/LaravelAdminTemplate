                        ...
                        <div class="card card-xl-stretch mb-xl-8">
                            ...
                            <div class="card-body pt-3">
                                ...
                                <div class="d-flex align-items-sm-center mb-7">
                                    ...
                                    <div class="symbol symbol-60px symbol-2by3 me-4">
                                        <div class="symbol-label"
                                            style="background-image: url({{  url('/assets/metronic/media/stock/600x400/img-20.jpg')  }})">
                                        </div>
                                    </div>
                                    <!--end::Symbol-->
                                    <!--begin::Title-->
                                ...
                                <div class="d-flex align-items-sm-center mb-7">
                                    ...
                                    <div class="symbol symbol-60px symbol-2by3 me-4">
                                        <div class="symbol-label"
                                            style="background-image: url({{  url('/assets/metronic/media/stock/600x400/img-19.jpg')  }})">
                                        </div>
                                    </div>
                                    <!--end::Symbol-->
                                    <!--begin::Title-->
                                ...
                                <div class="d-flex align-items-sm-center mb-7">
                                    ...
                                    <div class="symbol symbol-60px symbol-2by3 me-4">
                                        <div class="symbol-label"
                                            style="background-image: url({{  url('/assets/metronic/media/stock/600x400/img-25.jpg')  }})">
                                        </div>
                                    </div>
                                    <!--end::Symbol-->
                                    <!--begin::Title-->
                                ...
                                <div class="d-flex align-items-sm-center">
                                    ...
                                    <div class="symbol symbol-60px symbol-2by3 me-4">
                                        <div class="symbol-label"
                                            style="background-image: url({{  url('/assets/metronic/media/stock/600x400/img-24.jpg')  }})">
                                        </div>
                                    </div>
                                    <!--end::Symbol-->
                                    <!--begin::Title-->
                                    <div class="d-flex flex-row-fluid flex-wrap align-items-center">
                                        <div class="flex-grow-1 me-2">
                                            <a href="#"
                                                class="text-gray-800 fw-bolder text-hover-primary fs-6">Red Boots</a>
